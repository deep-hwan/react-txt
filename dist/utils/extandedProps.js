...
var extandedProps = function (props) {
    ...
    var stylePropKeys = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], layoutKeys, true), layerKeys, true), flexKeys, true), positionKeys, true), spaceKeys, true), borderKeys, true), scollKeys, true), typoKeys, true), mediaQueryKeys, true), hoverActiveKeys, true);
...
var hoverActiveKeys = ["active", "hover", "disabled"];
